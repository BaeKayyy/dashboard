...
const ProfileAvatar = ({ name, title, src }) => {
  return (
    <div className="text-center">
      <div className="w-20 h-20 mx-auto bg-zinx-200 rounded-full overflow-hidden mb-3 flex items-center justify-center text-zinc-500 text-lg">
        {src ? (
      ...
      <h3 className="texct-lg font-bold-text-zinc-600">
        {name}
      </h3>
